  ...
  return (
    <div className="space-y-8">
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-white">Cases</h1>
          <p className="mt-1 text-sm text-[#7aa0d8]">Manage your legal cases</p>
        </div>
        <Link
          href="#"
      ...
      <div className="rounded-2xl border border-[#162d58] bg-[#0a1628] p-12 text-center">
        <Briefcase className="mx-auto h-12 w-12 text-[#2a4f96]" />
        <h3 className="mt-4 text-lg font-semibold text-white">No cases yet</h3>
        <p className="mt-1 text-sm text-[#7aa0d8]">Create your first legal case to get started.</p>
      </div>
    </div>
  );
}
